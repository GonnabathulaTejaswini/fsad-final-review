    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/courses/*/submit").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/courses/*/materials").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/courses/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/courses/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/courses/**").hasRole("ADMIN")

                        // Assessments, learning, feedback, discussions, progress and questions
                        ...
                        .requestMatchers("/api/discussions/**").hasAnyRole("USER", "ADMIN")
