            ...
            {isAuthenticated && (
              <>
                <li className="list-none ml-5">
                  <Link 
                    to={"/learnings"}
                    className={`no-underline text-[17px] font-bold transition-all duration-300 ease-in-out hover:text-yellow-400 ${value === "learnings" ? "text-blue-600" : "text-[rgb(21,21,100)]"}`}
                  >
                    Learnings
                  </Link>
                </li>
                <li className="list-none ml-5">
                  <Link 
                    ...
                    className={`no-underline text-[17px] font-bold transition-all duration-300 ease-in-out hover:text-yellow-400 ${value === "dashboard" ? "text-blue-600" : "text-[rgb(21,21,100)]"}`}
                  >
                    Dashboard
                  </Link>
                </li>
